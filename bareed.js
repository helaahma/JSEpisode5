...
class Vendor extends Person {
  constructor(name, x, y) {
    super(name, x, y);
    // no need for constroctor or super
  }
  ...
  sellTo = (customer, numberOfIceCreams) => {
    ...
    customer.wallet.debit(price * numberOfIceCreams);
    this.wallet.credit(price * numberOfIceCreams);
  };
}
...
class Customer extends Person {
  ...
  requestIceCream = (vendor, numberOfIceCreams) => {
    if (
      this.__isInRange(vendor) &&
      this.__haveEnoughMoney(vendor, numberOfIceCreams)
    ) {
